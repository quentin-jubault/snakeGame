window.onload = function()
        {
            ...
            function gameOver()
            {
                ...
                ctx.strokeText("Appuyez sur Espace ou 🔄 pour rejouer",centreX, centreY - 120);
                ctx.fillText("Appuyez sur Espace ou 🔄 pour rejouer",centreX, centreY - 120);
                ctx.restore();
            }
            ...
            // ── Swipe tactile (alternative au joystick) ──
            var touchStartX = 0;
            var touchStartY = 0;
            ...
            document.addEventListener('touchend', function(e) {
                ...
                // Swipe seulement si déplacement > 30px
